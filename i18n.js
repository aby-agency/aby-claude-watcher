...
(function (root) {
  const strings = {
    fr: {
      ...
      update_up_to_date_hint: "Version {version} — dernière vérification à l'instant",
      ...
      update_rate_limited_hint: 'Cliquez sur "Vérifier" pour forcer',
    ...
    en: {
      ...
      update_up_to_date_hint: 'Version {version} — just checked',
      ...
      update_rate_limited_hint: 'Click "Check" to force',

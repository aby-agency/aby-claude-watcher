...
(function (root) {
  const strings = {
    fr: {
      ...
      state_delegating: 'Délégation',
      state_pending: 'Action requise',
      state_error: 'Erreur',
      background_section: 'Headless ({n})',
      bg_chip: '{n} tâche',
      bg_chip_n: '{n} tâches',
      server_chip: '{n} serveur',
      server_chip_n: '{n} serveurs',
      waiter_chip: '{n} attente',
      waiter_chip_n: '{n} attentes',
      bg_since: 'depuis {t}',
      bg_parked: 'parquée après timeout',
      dialog_chip: 'Dialogue ouvert',
      chrome_chip: 'Chrome',
...
settings_title: 'Paramètres',
      ...
      usage_win_session: '5h',
      usage_win_weekly: '7j',
      usage_tooltip_model: '{win} {model} : {pct}%{warn} — reset {time}',
    ...
    en: {
      ...
      bg_chip: '{n} task',
      bg_chip_n: '{n} tasks',
      server_chip: '{n} server',
      server_chip_n: '{n} servers',
      waiter_chip: '{n} wait',
      waiter_chip_n: '{n} waits',
      bg_since: 'since {t}',
      bg_parked: 'parked after timeout',
      dialog_chip: 'Dialog open',
      chrome_chip: 'Chrome',
